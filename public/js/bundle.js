...
var stripe = Stripe('pk_test_51HA5iKGnYAf0T9BkKd9hhEFl11AUe3lsF03X21bTRJ7Tpv5fSErhNw9eAqcRljnRoxRbqmxMnQs0E1HfQDvdMBIl00FxVdNKmY');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:8000/api/v1/bookings/checkout-session/".concat(tour.id));
